...
# fields for weights [SP note: check capitalisation of SA3 field names]
...
# exclude trips outside Greater Melbourne [SP note: check that this works as intended:
# field title, exact names]
trips_vista <- trips_vista %>%
...
pop_vista = sum(as.numeric(gsub(",", "", pp_vista[[wdperswgt]])), na.rm = T) +
  sum(as.numeric(gsub(",", "", pp_vista[[weperswgt]])), na.rm = T)  # [SP note: check weight fields in full VISTA as above]
