...
zone <- read_csv("~/models/manchester/input/zoneSystem.csv")
trips_ref <- read_csv("~/models/manchester/scenOutput/silo_mito_matsim_base_UT/2021/microData/trips.csv")

trips_cint <- read_csv("~/models/manchester/scenOutput/silo_mito_matsim_cycleIntervention_UT/2021/microData/trips.csv")

pp <- read_csv("~/models/manchester/microData/pp_2021.csv")
```
...
arrow::write_dataset(trips,path="simulationResults/ForUrbanTransition/trips_vis",format="parquet")

arrow::write_dataset(trips,path="~/models/rscripts/trips-vis/",format="parquet")
```
